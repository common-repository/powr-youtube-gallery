<?php
    ...
    Plugin URI: https://www.powr.io/plugins/youtube-gallery
    Description: Grow your audience with an embeddable YouTube gallery  Drop the widget anywhere in your theme. Or use the POWr icon in your WP text editor to add to a page or post. Edit on your live page by clicking the settings icon. More plugins and tutorials at POWr.io.
    Author: POWr.io
    Version: 1.6.4
    ...
    */
    ...
    function powr_youtube_gallery_options() {
      if(powr_local_mode()){//Determine JS url:
        $redirect_url = 'https://localhost:3000/wp-create/youtube-gallery';
      }else{
        $redirect_url = 'https://www.powr.io/wp-create/youtube-gallery';
      }
    ...
    register_activation_hook(__FILE__, 'powr_youtube_gallery_plugin_activate');
      ...
      if (get_option('powr_youtube_gallery_plugin_do_activation_redirect', false)) {
          ...
          {
            wp_redirect( get_admin_url().'?platform=wordpress&page=powr-youtube-gallery-settings&' );
          }
       }
      }
